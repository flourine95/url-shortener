...
This document covers the load testing methodology, parameters, and a side-by-side comparison of four architectural revisions of the URL shortener.

## Benchmarking methodology

Each benchmark run follows four constraints to produce comparable metrics:
...
2. **Resource-constrained VM**: The benchmark runs inside a WSL2 Linux VM allocated 4 vCPUs, 8 GB memory, and 2 GB swap. This emulates a production cloud container rather than using the full host machine
